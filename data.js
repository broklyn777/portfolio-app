export const data = [
    {
        ...
        name: "design",
        title: "Webb Design",
        desc: " Vi skapar nya hemsidor som är responsiva och användarvänliga, med analyser och relevanta förbättringar.",
        video: "Avocado.mp4",
        photo: "design.png",
        longDesc:
    ...
    },
    {
        ...
        name: "development",
        title: "Google Ads",
        desc: "Med effektiva annonskampanjer på Google kan du snabbt nå nya kunder, och få ditt företag att växa.",
        photo: "dev.jpeg",
        longDesc:
            "Simply drag and drop photos and videos into your workspace to automatically add them to your Collab Cloud library. Simply drag and drop photos and videos into your workspace to automatically add them to your Collab Cloud library.",
        images: [
